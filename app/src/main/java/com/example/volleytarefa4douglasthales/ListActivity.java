                                                   ...
                                                   public void onResponse(String response) {
                                                       try {
                                                           ...
                                                           for (int i=0; i < arr.length(); i++) {
                                                               String street = arr.getJSONObject(i).getJSONObject("address").getString("street");

                                                               double lat = arr.getJSONObject(i).getJSONObject("address").getJSONObject("geo").getDouble("lat");
                                                               double lng = arr.getJSONObject(i).getJSONObject("address").getJSONObject("geo").getDouble("lng");
